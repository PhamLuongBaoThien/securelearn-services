...
export const VARIABLE_WHITELIST: Record<string, string[]> = {
  ...
  COURSE_SUBSCRIPTION_APPROVED: ["instructorName", "courseName", "courseUrl"],
  COURSE_SUBSCRIPTION_REJECTED: ["instructorName", "courseName", "reason"],
  COURSE_SUBSCRIPTION_REMOVED: ["instructorName", "courseName", "reason"],
...
class TemplateService {
  ...
  async channelCapabilities() {
    ...
    const groups: Record<string, string[]> = {
      ...
      LEARNING: ["ENROLLMENT_CREATED", "DISCUSSION_CREATED", "DISCUSSION_REPLIED", "COURSE_ANNOUNCEMENT_PUBLISHED"],
      INBOX: [
        "REPORT_CREATED",
